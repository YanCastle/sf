...
class UniversalClassLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoadClass($className, $testClassName, $message)
    {
        ...
        $loader->registerNamespace('Namespaced', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerPrefix('Pearlike_', __DIR__.DIRECTORY_SEPARATOR);
    ...
    public function testUseIncludePath()
    {
        ...
        $this->assertEquals(__DIR__.DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR.'includepath'.DIRECTORY_SEPARATOR.'Foo.php', $loader->findFile('Foo'));
    ...
    {
        $loader = new UniversalClassLoader();
        $loader->registerNamespace('Foo', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerNamespace('Bar', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerNamespace('Bas', __DIR__.DIRECTORY_SEPARATOR);
    ...
    {
        $loader = new UniversalClassLoader();
        $loader->registerPrefix('Foo', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerPrefix('Bar', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerPrefix('Bas', __DIR__.DIRECTORY_SEPARATOR);
    ...
    public function testLoadClassFromFallback($className, $testClassName, $message)
    {
        ...
        $loader->registerNamespace('Namespaced', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerPrefix('Pearlike_', __DIR__.DIRECTORY_SEPARATOR);
        $loader->registerNamespaceFallbacks(array(__DIR__.DIRECTORY_SEPARATOR));
        $loader->registerPrefixFallbacks(array(__DIR__.DIRECTORY_SEPARATOR));
        $this->assertTrue($loader->loadClass($testClassName));
        $this->assertTrue(class_exists($className), $message);
    }
    ...
    {
        $loader = new UniversalClassLoader();
        $loader->registerPrefixFallback(__DIR__.DIRECTORY_SEPARATOR);
        $this->assertEquals(array(__DIR__.DIRECTORY_SEPARATOR), $loader->getPrefixFallbacks());
    }
        ...
        return array(
            array(
                array(
                    ...
                    'NamespaceCollision\\A\\B' => __DIR__.DIRECTORY_SEPARATOR,
                ),
    ...
    public function getLoadClassPrefixCollisionTests()
    {
        return array(
            array(
                array(
                    'PrefixCollision_A_' => __DIR__.DIRECTORY_SEPARATOR,
                    'PrefixCollision_A_B_' => __DIR__.DIRECTORY_SEPARATOR,
                ),
