...
class ClassLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testGetPrefixes()
    {
        ...
        $loader->addPrefix('Foo', __DIR__.DIRECTORY_SEPARATOR);
        $loader->addPrefix('Bar', __DIR__.DIRECTORY_SEPARATOR);
        $loader->addPrefix('Bas', __DIR__.DIRECTORY_SEPARATOR);
    ...
    {
        $loader = new ClassLoader();
        $loader->addPrefix(null, __DIR__.DIRECTORY_SEPARATOR);
        $loader->addPrefix(null, __DIR__.DIRECTORY_SEPARATOR);
    ...
    {
        $loader = new ClassLoader();
        $loader->addPrefix('Namespaced2\\', __DIR__.DIRECTORY_SEPARATOR);
        $loader->addPrefix('Pearlike2_', __DIR__.DIRECTORY_SEPARATOR);
    ...
    public function testLoadClassFromFallback($className, $testClassName, $message)
    {
        ...
        $loader->addPrefix('Namespaced2\\', __DIR__.DIRECTORY_SEPARATOR);
        $loader->addPrefix('Pearlike2_', __DIR__.DIRECTORY_SEPARATOR);
        $loader->addPrefix('', array(__DIR__.DIRECTORY_SEPARATOR));
        $loader->loadClass($testClassName);
        $this->assertTrue(class_exists($className), $message);
    }
    ...
    public function getLoadClassNamespaceCollisionTests()
    {
        return array(
            array(
                array(
                    'NamespaceCollision\\C' => __DIR__.DIRECTORY_SEPARATOR,
                    'NamespaceCollision\\C\\B' => __DIR__.DIRECTORY_SEPARATOR,
                ),
            ...
            array(
                array(
                    'PrefixCollision_C_' => __DIR__.DIRECTORY_SEPARATOR,
                    'PrefixCollision_C_B_' => __DIR__.DIRECTORY_SEPARATOR,
                ),
